...
class TestOraclePostgresCountsCheck:
    ...
    def setup_count_data(self, oracle_engine, postgres_engine, table_helper):
        ...
        mismatch_table = 'test_ora_pg_cnt_mm'
        table_helper.create_table(
            engine=oracle_engine,
    ...
    def test_total_counts_date_range(self, oracle_engine, postgres_engine):
        table_name = 'test_ora_pg_counts'
    ...
    def test_total_counts_open_ended(self, oracle_engine, postgres_engine):
        table_name = 'test_ora_pg_counts'
    ...
    def test_total_counts_mismatch(self, oracle_engine, postgres_engine):
        table_name = 'test_ora_pg_cnt_mm'
