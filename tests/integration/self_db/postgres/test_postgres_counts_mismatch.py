"""PostgreSQL count mismatch: source has an extra day."""
...
class TestPostgresCountMismatch:
    @pytest.fixture(autouse=True)
    def setup_mismatch_data(self, postgres_engine, table_helper):
        source_table = 'test_pg_counts_mismatch_src'
        target_table = 'test_pg_counts_mismatch_trg'
    ...
    def test_total_counts_mismatch(self, postgres_engine):
        ...
        source_ref = DataReference('test_pg_counts_mismatch_src', 'test')
        target_ref = DataReference('test_pg_counts_mismatch_trg', 'test')
    ...
    def test_counts_group_by_date_mismatch(self, postgres_engine):
        checker = DataQualityChecker(
            source_engine=postgres_engine,
            target_engine=postgres_engine,
            timezone='UTC',
